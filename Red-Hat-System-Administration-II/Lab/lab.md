...
1.1 Đăng nhập vào máy chủ với tư cách là người dùng sinh viên và chuyển sang người dùng gốc.
...
1.1 Đăng nhập vào servera với tư cách là người dùng sinh viên và chuyển sang người dùng gốc.
...
- Là người dùng học viên trên máy trạm, hãy sử dụng lệnh lab để chuẩn bị hệ thống của bạn cho bài tập này.
...
[student@workstation ~]$
```
5.6 Sau khi hệ thống khởi động lại, hãy mở phiên SSH đến serverb với tư cách là người dùng sinh viên. Kiểm tra xem mục tiêu nhiều người dùng đã được đặt làm mục tiêu mặc định chưa.
...
6. Trên serverb, hãy lên lịch một tác vụ định kỳ với tư cách là người dùng sinh viên, thực thi tập lệnh /home/student/backup-home.sh hàng giờ từ 19:00 đến 21:00 tất cả các ngày trừ Thứ Bảy và Chủ Nhật. Sử dụng tập lệnh backup-home.sh để lên lịch tác vụ định kỳ. Tải xuống tập lệnh sao lưu từ http://materials.example.com/labs/backup-home.sh. Chạy lệnh dưới dạng tệp thực thi.
...
4.1 Tạo phân vùng 512 MiB trên đĩa /dev/vdc.
...
...output omitted...
```
4.2 Tạo không gian hoán đổi trên phân vùng /dev/vdc1.
...
Trên serverb, tạo cặp khóa SSH cho người dùng sinh viên. Không bảo vệ khóa riêng bằng mật khẩu.

Cấu hình người dùng sinh viên trên servera để chấp nhận xác thực đăng nhập bằng cặp khóa SSH mà bạn đã tạo trên máy serverb. Người dùng sinh viên trên serverb phải có thể đăng nhập vào servera qua SSH mà không cần nhập mật khẩu.
...
1. Trên serverb, hãy tạo cặp khóa SSH cho người dùng sinh viên. Không bảo vệ khóa riêng bằng cụm mật khẩu.
...
2. Cấu hình người dùng sinh viên trên servera để chấp nhận xác thực đăng nhập bằng cặp khóa SSH mà bạn đã tạo trên máy serverb. Người dùng sinh viên trên serverb phải có thể đăng nhập vào servera qua SSH mà không cần nhập mật khẩu.

2.1 Gửi khóa công khai của cặp khóa SSH mới tạo tới người dùng sinh viên trên máy chủ.
...
```
2.2 Xác minh rằng người dùng sinh viên có thể đăng nhập vào servera từ serverb mà không cần nhập mật khẩu. Không đóng kết nối.
...
5.1 Mở một cửa sổ terminal mới và xác minh từ servera rằng người dùng production5 không thể đăng nhập vào serverb bằng xác thực dựa trên khóa SSH. Một SELinux Boolean đang ngăn người dùng đăng nhập. Từ máy trạm, hãy mở một terminal mới và đăng nhập vào servera với tư cách là người dùng student.
```
[student@workstation ~]$ ssh student@servera
...output omitted...
[student@servera ~]$
...
passwd: all authentication tokens updated successfully.
```
1.4 Thoát khỏi phiên người dùng sinh viên. Đăng nhập vào máy serverb với tư cách người dùng podmgr. Nếu được yêu cầu, hãy sử dụng redhat làm mật khẩu.
